...
public interface UserMapper {
    ...
    @Select("SELECT * FROM i_user where 1=1 and ${attributes}")
    ArrayList<IUser> findAllByAttrAndStatus(@Param("attributes") String attributes);
    ...
    @Select("SELECT * FROM i_user where status !='inactive' and ${attributes}  limit 1 ")
    IUser findByAttr(@Param("attributes") String attributes);
